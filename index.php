        ...
        <div class="container">
            <div class="row py-5">
                ...
                <div class="
                    ...
                    <img src="img/banner.gif" alt="Tapeeo Card" class="img-fluid img-responsive">
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="row">
                            ...
                            <div class="step-2 mt-4">
                                <div class="row align-items-center justify-content-center">
                                     <!-- step 2 first row -->
                                    <div class="col step-2-img mt-2 d-flex align-items-center flex-column">
                            ...
                            <div class="col-12 step-3 mt-4">
                                <div class="step-2-img mt-4">
                                    ...
                                    <p class="showHideContentDiv-0 showHideContentDiv">After signing up on Tapeeo.app. You can start making single purpose web pages called Tapeeo. You can make Sitches to take payments, share links like a Calendly or Google form, sell products, start chats, book appointments, give outforms, share files,and much more</p>
                                    
                                    <p class="showHideContentDiv-1 showHideContentDiv showAndHide"> You then select the Tapeeo you want for the moment and tap. It's that simple.</p>

                                    <p class="showHideContentDiv-2 showHideContentDiv showAndHide">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.</p>

                                    <p class="showHideContentDiv-3 showHideContentDiv showAndHide">No apps to download. Just tap or scan your newly purchased Tapeeo device to get set up instantly. The phones you tap don't need to download anything either and it works on both Android and iOS devices.</p>
                                </div>
                            </div> 
                            <div class="col-12">
                                <div class="content-text  pt-3 pt-sm-3 pt-md-3 pt-lg-0 pt-xxl-0">
                                    <p>
                                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quod unde aut cum fugiat praesentium quas sequi sint, vel ex nihil laudantium modi? Sit fuga blanditiis ipsum minus animi vero illum.
                                    </p>
                                </div>
                            </div>                                   
                        </div>
