                                ...
                                ?>
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xxl-6 gy-3 d-table">
                                        ...
                                        <div class="address-card">
                                            ...
                                            <p class="<?php if ($address['default'] == 0) {
                                                            echo 'mb-2';
                                                        } else {
                                                            echo 'mb-4 pb-2';
                                                        } ?>">Postal Code : <?php echo $address['pincode']; ?></p>
                                            <div class="address-func">
                                                ...
                                                <div class="edit-delete mt-2">
                                                    <a href="" data-bs-toggle="modal" data-bs-target="#exampleModal" class="me-2 edit-this" data-this-id='<?php echo $address['id']; ?>' data-name='<?php echo $address['name']; ?>' data-email='<?php echo $address['email']; ?>' data-phone='<?php echo $address['phone']; ?>' data-city='<?php echo $address['city']; ?>' data-state='<?php echo $address['state']; ?>' data-country='<?php echo $address['country']; ?>' data-address='<?php echo $address['address']; ?>' data-pincode='<?php echo $address['pincode']; ?>' data-type='<?php echo $address['type']; ?>'>Edit Address </a>
